...
$game = null;
if ($game_id > 0) {
    $stmt = $conn->prepare("SELECT * FROM games WHERE id = ? AND name LIKE '%Free Fire%'");
...
<body>
    ...
    <div class="header">
        ...
        <p>Focus on Diamond sales and Elite Pass performance</p>
    </div>
    ...
    <div class="summary-container">
        ...
        <div class="summary-card">
            <h3>Elite Pass Sales</h3>
            <div class="value">Rp<?php echo number_format($sales_summary['pass_sales'] ?? 0, 0, ',', '.'); ?></div>
            <small><?php echo number_format($sales_summary['pass_count'] ?? 0); ?> passes sold</small>
        </div>
        <div class="summary-card">
            <h3>Profit Margin</h3>
