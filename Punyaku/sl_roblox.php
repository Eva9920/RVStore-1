...
$game = null;
if ($game_id > 0) {
    $stmt = $conn->prepare("SELECT * FROM games WHERE id = ? AND name LIKE '%Roblox%'");
...
// Get Robux sales summary
$sales_summary = [];
$stmt = $conn->prepare("
    SELECT 
        SUM(tp.in_game_currency) AS total_robux_sold,
...
<body>
    ...
    <div class="summary-container">
        <div class="summary-card">
            <h3>Total Robux Sold</h3>
            <div class="value"><?php echo number_format($sales_summary['total_robux_sold'] ?? 0); ?>
        </div>
        <div class="summary-card">
            <h3>Total Sales</h3>
